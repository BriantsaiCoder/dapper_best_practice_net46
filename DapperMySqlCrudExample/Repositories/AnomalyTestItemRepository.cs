    ...
    public sealed class AnomalyTestItemRepository
    {
        ...
        public long Insert(AnomalyTestItem entity, IDbTransaction transaction = null)
        {
            ...
            catch (Exception ex)
            {
                _logger.Error(
                    ex,
                    "Insert anomaly_test_items 失敗 | AnomalyLotId={AnomalyLotId} | TestItemName={TestItemName} | SiteId={SiteId}",
                    entity.AnomalyLotId,
                    entity.TestItemName,
                    entity.SiteId
                );
        ...
        public bool Update(AnomalyTestItem entity, IDbTransaction transaction = null)
        {
            ...
            {
                _logger.Error(ex, "Update anomaly_test_items 失敗 | Id={Id}", entity.Id);
                throw;
            }
        }
        ...
        public bool Delete(long id, IDbTransaction transaction = null)
        {
            ...
            {
                _logger.Error(ex, "Delete anomaly_test_items 失敗 | Id={Id}", id);
                throw;
            }
        }
