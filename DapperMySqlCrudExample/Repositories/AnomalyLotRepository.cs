...
namespace DapperMySqlCrudExample.Repositories
{
    ...
    public sealed class AnomalyLotRepository
    {
        ...
        public long Insert(AnomalyLot entity, IDbTransaction transaction = null)
        {
            ...
            const string insertSql =
                ...
                INSERT INTO anomaly_lots
                    (lots_info_id, site_id, detection_method_id, detection_value, offset_value,
                     spec_upper_limit, spec_lower_limit)
                VALUES
                    (@LotsInfoId, @SiteId, @DetectionMethodId, @DetectionValue, @OffsetValue,
        ...
        public bool Update(AnomalyLot entity, IDbTransaction transaction = null)
        {
            ...
            {
                _logger.Error(ex, "Update anomaly_lots 失敗 | Id={Id}", entity.Id);
                throw;
            }
        }
        ...
        public bool Delete(long id, IDbTransaction transaction = null)
        {
            ...
            {
                _logger.Error(ex, "Delete anomaly_lots 失敗 | Id={Id}", id);
                throw;
            }
        }
